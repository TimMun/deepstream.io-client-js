...
export declare const getRecordServices: (services: any) => {
    ...
    bulkSubscriptionService: {
        [RECORD_ACTION.SUBSCRIBECREATEANDREAD]: BulkSubscriptionService<RECORD_ACTION>;
        [RECORD_ACTION.SUBSCRIBEANDHEAD]: BulkSubscriptionService<RECORD_ACTION>;
        [RECORD_ACTION.SUBSCRIBEANDREAD]: BulkSubscriptionService<RECORD_ACTION>;
    };
    verify: () => void;
};
