...
describe('Presence handler', function () {
    ...
    beforeEach(function () {
        ...
        promiseSuccess = (0, sinon_1.spy)();
        promiseError = (0, sinon_1.spy)();
        counter = 0;
    });
    afterEach(function () {
        services.verify();
    ...
    it('validates parameters on subscribe, unsubscribe and getAll', function () {
        (0, chai_1.expect)(presenceHandler.subscribe.bind(presenceHandler)).to.throw();
        (0, chai_1.expect)(presenceHandler.subscribe.bind(presenceHandler, 'name')).to.throw();
        (0, chai_1.expect)(presenceHandler.subscribe.bind(presenceHandler, '', function () { })).to.throw();
        (0, chai_1.expect)(presenceHandler.unsubscribe.bind(presenceHandler, '')).to.throw();
    });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, utils_1.PromiseDelay)(5)];
                case 1:
                    _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, utils_1.PromiseDelay)(options.subscriptionInterval * 2)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('resubscribes subscriptions when client reconnects', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    counter = parseInt((0, mocks_1.getLastMessageSent)().correlationId, 10) + 1;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        handle(messageForCallback);
                        handle(messageForPromise);
                        return [4 /*yield*/, (0, utils_1.PromiseDelay)(2)];
                    case 1:
                        _a.sent();
                        sinon_1.assert.calledOnce(callback);
    ...
    describe('when subscribing to userA, userB and all', function () {
        ...
        beforeEach(function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        userACallback = (0, sinon_1.spy)();
                        userBCallback = (0, sinon_1.spy)();
                        allUsersCallback = (0, sinon_1.spy)();
