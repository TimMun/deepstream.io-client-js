    ...
    it('miss heartbeat once', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, (0, utils_1.PromiseDelay)(heartbeatInterval * 1.5)
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, (0, utils_1.PromiseDelay)(10)];
                case 4:
                    _a.sent();
                    return [2 /*return*/];
            }
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 6:
                    // try to reconnect second time
                    _a.sent();
                    return [4 /*yield*/, (0, utils_1.PromiseDelay)(25)
                ...
                case 8:
                    // try to reconnect third time (now max is reached)
                    _a.sent();
                    return [4 /*yield*/, (0, utils_1.PromiseDelay)(45)
                ...
                case 10:
                    // try to reconnect fourth time (try to surpass the allowed max, fail)
                    _a.sent();
                    return [4 /*yield*/, (0, utils_1.PromiseDelay)(70)];
                case 11:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('goes into limbo on connection lost', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    limboSpy = (0, sinon_1.spy)();
                    connection.onExitLimbo(limboSpy);
                    return [4 /*yield*/, loseConnection()];
                case 2:
                    _a.sent();
                    (0, chai_1.expect)(connection.isInLimbo).to.equal(true);
                    return [4 /*yield*/, (0, utils_1.PromiseDelay)(20)];
                case 3:
                    _a.sent();
                    sinon_1.assert.calledOnce(limboSpy);
                    (0, chai_1.expect)(connection.isInLimbo).to.equal(false);
                    return [2 /*return*/];
            }
        });
    }); });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        (0, chai_1.expect)(socket.url).to.equal(initialUrl);
                        socket.simulateOpen();
                        return [4 /*yield*/, (0, utils_1.PromiseDelay)(0)];
                    case 1:
                        _a.sent();
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        emitterMock
                            ...
                            .withExactArgs(constants_1.EVENT.CONNECTION_STATE_CHANGED, constants_1.CONNECTION_STATE.CHALLENGING);
                        getSocketMock();
                        (0, chai_1.expect)(socket.url).to.equal(otherUrl);
                        socket.simulateOpen();
                        return [4 /*yield*/, (0, utils_1.PromiseDelay)(0)];
                    case 1:
                        _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        (0, chai_1.expect)(connection.isConnected).to.equal(false);
                        return [2 /*return*/];
                }
            });
        });
