...
describe('RPC response', function () {
    ...
    it('throws when trying to send a completed response', function () {
        ...
        services.connectionMock
            ...
            .twice();
        rpcResponse.send(data);
        (0, chai_1.expect)(rpcResponse.send.bind(rpcResponse, data)).to.throw("Rpc ".concat(name, " already completed"));
    });
    ...
    it('doesn\'t send reject message twice and throws error', function () {
        services.connectionMock
            ...
            .once();
        rpcResponse.reject();
        (0, chai_1.expect)(rpcResponse.reject.bind(rpcResponse)).to.throw("Rpc ".concat(name, " already completed"));
    });
    ...
    it('doesn\'t send error message twice and throws error', function () {
        ...
        services.connectionMock
            ...
            .once();
        rpcResponse.error(error);
        (0, chai_1.expect)(rpcResponse.error.bind(rpcResponse, error)).to.throw("Rpc ".concat(name, " already completed"));
    });
});
