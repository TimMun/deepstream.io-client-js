...
describe('Record handler', function () {
    ...
    var handle;
    beforeEach(function () {
        callbackSpy = (0, sinon_1.spy)();
        resolveSpy = (0, sinon_1.spy)();
        rejectSpy = (0, sinon_1.spy)();
        services = (0, mocks_1.getServicesMock)();
        recordServices = (0, mocks_1.getRecordServices)(services);
    ...
    it('validates on has, head and snapshot', function () {
        (0, chai_1.expect)(recordHandler.has.bind(recordHandler, '')).to.throw();
        (0, chai_1.expect)(recordHandler.has.bind(recordHandler, '', function () { })).to.throw();
        (0, chai_1.expect)(recordHandler.head.bind(recordHandler, '')).to.throw();
        (0, chai_1.expect)(recordHandler.head.bind(recordHandler, '', function () { })).to.throw();
        (0, chai_1.expect)(recordHandler.snapshot.bind(recordHandler, '')).to.throw();
        (0, chai_1.expect)(recordHandler.snapshot.bind(recordHandler, '', function () { })).to.throw();
    });
    ...
    describe('record setData online', function () {
        ...
        it('throws error for invalid arguments', function () {
            (0, chai_1.expect)(recordHandler.setData.bind(recordHandler)).to.throw();
            (0, chai_1.expect)(recordHandler.setData.bind(recordHandler, name)).to.throw();
            // @ts-ignore
            (0, chai_1.expect)(recordHandler.setData.bind(recordHandler, name, undefined)).to.throw();
            // @ts-ignore
            (0, chai_1.expect)(recordHandler.setData.bind(recordHandler, name, undefined, function () { })).to.throw();
            (0, chai_1.expect)(recordHandler.setData.bind(recordHandler, name, null)).to.throw();
            (0, chai_1.expect)(recordHandler.setData.bind(recordHandler, name, null, function () { })).to.throw();
            (0, chai_1.expect)(recordHandler.setData.bind(recordHandler, name, '', 'data')).to.throw();
            (0, chai_1.expect)(recordHandler.setData.bind(recordHandler, name, 'Some String')).to.throw();
            // @ts-ignore
            (0, chai_1.expect)(recordHandler.setData.bind(recordHandler, name, 100.24)).to.throw();
            (0, chai_1.expect)(recordHandler.setData.bind(recordHandler, name, {}, { not: 'func' })).to.throw();
        });
        describe('with ack', function () {
            ...
            it('sends update messages for entire data changes with ack promise', function () {
                ...
                (0, chai_1.expect)(promise).is.a('promise');
            });
        ...
        describe('clearing storage', function () {
            it('calls callback with nothing when successful', function (done) {
                ...
                recordHandler.clearOfflineStorage(function (error) {
                    (0, chai_1.expect)(error).to.equal(null);
                    done();
                });
            });
            it('calls callback with error when unsuccessful', function (done) {
                ...
                recordHandler.clearOfflineStorage(function (error) {
                    (0, chai_1.expect)(error).to.equal('failed');
                    done();
                });
            });
            ...
            it('returns promise that rejects with error when unsuccessful', function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 3:
                            e_1 = _a.sent();
                            (0, chai_1.expect)(e_1).to.equal('failed');
                            return [2 /*return*/];
                        case 4:
                            (0, assert_1.fail)('The promise should have failed');
                            return [2 /*return*/];
                    }
                });
            }); });
        ...
        describe('handling acknowledgements', function () {
            ...
            var ackReject;
            beforeEach(function () {
                ackCallback = (0, sinon_1.spy)();
                ackResolve = (0, sinon_1.spy)();
                ackReject = (0, sinon_1.spy)();
            });
            var errorMsg = {
                topic: topic,
                action: constants_1.RECORD_ACTION.MESSAGE_DENIED,
