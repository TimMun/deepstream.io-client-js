...
describe('record core', function () {
    describe('online scenario, not individual tests', function () {
        ...
        it('triggers ready promise on read response', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        (0, chai_1.expect)(readyContext).to.equal(context);
                        return [2 /*return*/];
                }
            });
        }); });
        ...
        it('queues discarding record when no longer needed', function () {
            ...
            (0, chai_1.expect)(recordCore.recordState).to.equal("UNSUBSCRIBING" /* UNSUBSCRIBING */);
            (0, chai_1.expect)(recordCore.isReady).to.equal(true);
        });
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, (0, utils_1.PromiseDelay)(30)];
                        case 1:
                            _a.sent();
                            (0, chai_1.expect)(recordCore.recordState).to.equal("READY" /* READY */);
                            (0, chai_1.expect)(recordCore.isReady).to.equal(true);
                            return [2 /*return*/];
                    }
                });
            ...
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.sent();
                            (0, chai_1.expect)(recordCore.recordState).to.equal("UNSUBSCRIBED" /* UNSUBSCRIBED */);
                            sinon_1.assert.calledOnce(whenCompleted);
                            sinon_1.assert.calledWithExactly(whenCompleted, name);
                            (0, chai_1.expect)(recordCore.isReady).to.equal(false);
                            return [2 /*return*/];
                    }
                });
            });
        ...
        it('sends delete when ready', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                recordCore.delete();
                (0, chai_1.expect)(recordCore.recordState).to.equal("DELETING" /* DELETING */);
        ...
        it('calls delete when delete is confirmed', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                (0, chai_1.expect)(recordCore.recordState).to.equal("DELETED" /* DELETED */);
                sinon_1.assert.calledOnce(whenCompleted);
                sinon_1.assert.calledWithExactly(whenCompleted, name);
                    ...
                    switch (_a.label) {
                        case 0:
                            services.storageMock
                                ...
                                .callsArgWith(3, null);
                            recordCore.removeReference(this);
                            return [4 /*yield*/, (0, utils_1.PromiseDelay)(40)];
                        case 1:
                            _a.sent();
                            (0, chai_1.expect)(recordCore.recordState).to.equal("UNSUBSCRIBED" /* UNSUBSCRIBED */);
                            sinon_1.assert.calledOnce(whenCompleted);
