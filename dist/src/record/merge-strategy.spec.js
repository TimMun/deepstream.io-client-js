...
describe('merge strategies @unit', function () {
    ...
    describe('remote wins', function () {
        beforeEach(function () {
            this.mergeCallback = (0, sinon_1.spy)();
            localVersion = 1;
        ...
        it('returns the remote data', function () {
            (0, chai_1.expect)(this.mergeCallback.calledOnce)
                .to.equal(true);
            (0, chai_1.expect)(this.mergeCallback.calledWith(null, { type: 'remote' }))
                .to.equal(true);
        });
    });
    describe('local wins', function () {
        ...
        it('returns the remote data', function () {
            (0, chai_1.expect)(this.mergeCallback.calledOnce)
                .to.equal(true);
            (0, chai_1.expect)(this.mergeCallback.calledWith(null, { type: 'local' }))
                .to.equal(true);
        });
    });
});
