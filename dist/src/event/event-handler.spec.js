...
describe('event handler', function () {
    ...
    beforeEach(function () {
        ...
        listener = (0, mocks_1.getListenerMock)();
    ...
    it('gets events names', function () {
        ...
        (0, chai_1.expect)(eventHandler.eventNames()).to.deep.equal(['event1', 'event2']);
        eventHandler.unsubscribe('event2', spy);
        (0, chai_1.expect)(eventHandler.eventNames()).to.deep.equal(['event1']);
    });
    it('validates parameters on subscribe, unsubscribe and emit', function () {
        (0, chai_1.expect)(eventHandler.subscribe.bind(eventHandler, '', function () { })).to.throw();
        (0, chai_1.expect)(eventHandler.unsubscribe.bind(eventHandler, '', function () { })).to.throw();
        (0, chai_1.expect)(eventHandler.emit.bind(eventHandler, '', {})).to.throw();
    });
