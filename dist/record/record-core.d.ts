...
export declare class RecordCore<Context = null> extends Emitter {
   ...
   */
     ...
     */
    recoverRecord(remoteVersion: number, remoteData: RecordData): void;
    /**
   * Callback once the record merge has completed. If successful it will set the
   * record state, else emit and error and the record will remain in an
   * inconsistent state until the next update.
   */
    onRecordRecovered(error: string | null, recordName: string, mergedData: RecordData, remoteVersion: number, remoteData: RecordData): void;
    /**
